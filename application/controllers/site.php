...
if($this->careers_model->create($title,$experience,$qualification,$openings,$area)==0)
...
$openings=$this->input->get_post("openings");
$area=$this->input->get_post("area");
if($this->careers_model->edit($id,$title,$experience,$qualification,$openings,$area)==0)
